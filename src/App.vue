...
<template>
  <pv-toolbar class="bg-gray-900 shadow-2" style="background-image: linear-gradient(to right, #1472df, #0A1642); color: #fff;">
    <template #start>
    ...
    <template #end>
        <div class="flex align-items-center gap-2">
            ...
            <i style="cursor: pointer;" class="pi pi-sign-out"></i>
        </div>
    </template>
</pv-toolbar>
